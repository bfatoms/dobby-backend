...
class ChartOfAccountCreateRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        if (request('type') == "bank") {
            return [
                'bank_name' => 'required',
                'name' => 'required',
                'code' => 'required|min:3|alpha_num|unique:chart_of_accounts,code',
                'type' => 'required',
        ...
        return [
            'name' => 'required',
            'code' => 'required|min:3|max:10|alpha_num|unique:chart_of_accounts,code',
            'type' => 'required',
